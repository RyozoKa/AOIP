	...
	//	if (GetDstIP((const char*)Data) == ( (129 << 24) | (1 << 16) | (0 << 8) | 224) && Header->len == 86)
		{
			...
			//	DumpBytes(Data, Bytes);
				...
				TempTS /= 1000000000.0;
				//Seconds
				TempTS += (double)((unsigned int)(ntohll(*((unsigned long long*)(Data + 34))) >> 16));
		...
		//	Bytes = 0;
			...
			if (Bytes == 44 && (SockState == R_PTPF || SockState == R_PTPS) )
			{
				...
				else if (SockState == R_PTPF && LocalTS > -1.0)
				{
					...
					//Only unsigned math
					//printf("Delta %.9f\n", ((TempTS + PGDelay) - Start) / TSFreq);
			/*		if ((((TempTS + PGDelay) - Start) / TSFreq) > 0.000100 || (((TempTS + PGDelay) - Start) / TSFreq) < -0.000100)
					{
						LocalTS = -1.0;
						continue;
					}*/
				...
				/*	ss += "Delta "; 
					ss += std::to_string((double)(((TempTS + PGDelay) - Start) / TSFreq));
					ss += "\n";*/
